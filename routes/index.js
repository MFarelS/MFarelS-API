...
router.get('/api/magernulis1', (req, res) => {
...
router.get('/api/magernulis1V2', (req, res) => {
    var text = req.query.text
...
router.get('/api/hartatahta', (req, res) => {
    var text = req.query.text
...
router.get('/api/hartatahtaV2', (req, res) => {
    var text = req.query.text
...
router.get('/api/customhartatahta', (req, res) => {
    var text = req.query.text
    ...
    .on('error', () => {
        res.status(500).json({ By: 'MFarelS - mfarelsz.xyz', status: 500, message: 'Error. Internal Server Error, Gagal/Kesalahan Dalam Membuat ' + text, url: 'https://mfarelsz.xyz/api/customhartatahta?text=' + text })
    })
    .on('exit', () => {
        /*res.status(200).json({ creator: 'MFarelSZ', status: 200, text: text, result: result.replace(process.cwd(), req.headers.host).replace('/public', '') })*/
...
router.get('/api/customhartatahtaV2', (req, res) => {
    var text = req.query.text
...
/*router.get('/api/shaunthesheep', async (req, res) => {
...
router.get('/api/pastebin', async (req, res) => {
...
router.get('/api/randomquotes', async (req, res) => {
...
router.get('/api/kode-bahasa', async (req, res) => {
...
router.get('/api/koin', async (req, res) => {
...
router.get('/api/dadu', async (req, res) => {
...
router.get('/api/kapankah', async (req, res) => {
...
router.get('/api/apakah', async (req, res) => {
...
router.get('/api/covid19-indonesia', async (req, res) => {
...
router.get('/api/qrcodeV2', async (req, res) => {
    var text = req.query.text
...
router.get('/api/qrcode2', async (req, res) => {
/*    var text = req.query.text
...
router.get('/api/qrcode2V2', async (req, res) => {
/*    var text = req.query.text
...
router.get('/api/penyegaran-timelane', async (req, res) => {
...
router.get('/api/kucing', async (req, res) => {
...
router.get('/api/animedl1/', async (req, res) => {
    var q = req.query.q
...
router.get('/api/animedl2', async (req, res) => {
    var q = req.query.q
...
router.get('/api/facebookdl', async (req, res) => {
...
router.get('/api/lirik', async (req, res) => {
    try {
...
router.get('/api/rangkum', async (req, res) => {
    var text = req.query.text
...
router.get('/api/speed', async (req, res) => {
    let timestamp = speed();
    let latensi = speed() - timestamp
    res.status(200).json({ By: 'MFarelS - mfarelsz.xyz', speed: `${latensi.toFixed(4)} Detik` })
})

router.get('/api/cek-server-minecraft', async (req, res) => {
    var ip = req.query.ip
...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'MFarelS' });
});
